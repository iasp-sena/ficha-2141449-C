...
@NamedQueries({
    ...
    @NamedQuery(name = "TipoDocumento.findByIdTipoDocumento", query = "SELECT t FROM TipoDocumento t WHERE t.id = :idTipoDocumento"),
...
public class TipoDocumento implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.csf.adsi.fichas.agc.web.tallerhoteles.modelo.TipoDocumento[ idTipoDocumento=" + id + " ]";
    }
